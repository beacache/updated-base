 ...
 */
 ...
 // Force enable TLS with mbedTLS
#ifndef IXWEBSOCKET_USE_TLS
#define IXWEBSOCKET_USE_TLS
#endif

#ifndef IXWEBSOCKET_USE_MBED_TLS
#define IXWEBSOCKET_USE_MBED_TLS
#endif
...
// Auto-detect mbedTLS version
#include <mbedtls/version.h>
#if MBEDTLS_VERSION_MAJOR >= 3
#define IXWEBSOCKET_USE_MBED_TLS_MIN_VERSION_3
#endif
...
namespace ix
{
    ...
    bool SocketMbedTLS::loadSystemCertificates(std::string& errorMsg)
    {
        ...
        while ((certificateIterator = CertEnumCertificatesInStore(systemStore, certificateIterator)) != NULL)
        {
        ...
        else
        {
            ...
            else
            {
                if (_tlsOptions.isUsingInMemoryCAs())
                {
                    ...
                    size_t bufferSize = _tlsOptions.caFile.size() + 1;
