...
namespace module::update {
    ...
    namespace luau {
        ...
        const auto rbx_crash_log = rebase<std::uintptr_t>(0x4a63f90);
    ...
    namespace extra_space {
        ...
        const auto attach = rebase<attach_roblox_extra_space_t>(0x1d32ea0);
    ...
    namespace flags {
        ...
        const auto get_fast_flag = rebase<std::uintptr_t>(0x534e210); // inc
    ...
    namespace hyperion {
        const auto control_flow_guard = hyperion_rebase<std::uintptr_t>(0x3e12d0);
        const auto bitmap = hyperion_rebase<std::uintptr_t>(0x1531d60);
